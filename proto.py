...
'''
Basic chatbot to simulate discourse between a person and a banking system. Create an instance of the `account` class to simulate an account with balance, 
username, password and authentication status. Manipulation of these attributes and class methods happen through this program, displaying account information 
and mutating them as needed.
'''
