...
def insert_row(connection, user, password, email, balance):
    cursor = connection.cursor()
    #Encrypt class (?) -->
    cursor.execute(f'INSERT INTO bank_accounts (user, pass, email, balance) VALUES ("{user}", "{password}", "{email}", "{balance}");')
    connection.commit()
    cursor.close()
